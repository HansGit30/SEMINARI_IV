...
const MODEL_URL = "https://teachablemachine.withgoogle.com/models/NE7h3jACi/";
...
export const Imagen: React.FC = () => {
  ...
  const processImageSrc = async (src: string) => {
    ...
    imgElement.onload = async () => {
      try {
        ...
        const results = await model.predict(imgElement);
  ...
  // Carga de archivo de imagen local
  ...
  return (
    <div style={styles.container}>
      {/* Encabezado con estilo Hero de la segunda imagen */}
      <header style={styles.heroHeader}>
        <div style={styles.badgeTop}>
          <span style={{ color: "#b4f461" }}>⚡</span> INTELIGENCIA ARTIFICIAL
        </div>
        <h1 style={styles.heroTitle}>
          Tu Próximo Análisis <br />
          <span style={styles.titleHighlight}>Inteligente</span>
          <span style={styles.iconBox}>📷</span>
          <span style={styles.titleGray}>Empieza Aquí</span>
        </h1>
        <p style={styles.heroSubtitle}>
          Sube una imagen desde tu dispositivo o toma una foto en tiempo real con tu cámara para obtener una clasificación rápida y precisa.
        </p>
      </header>
      ...
      {/* Zona de Selección (Subir Archivo o Activar Cámara) */}
      {!isCameraActive && (
          ...
          <div style={styles.uploadCard}>
            <label htmlFor="file-upload" style={styles.uploadLabel}>
              ...
              <span style={{ fontWeight: "600", fontSize: "16px" }}>
                {loading ? "Procesando..." : "Haz clic para subir una imagen"}
              </span>
          ...
          return (
            <div key={item.id} style={styles.card}>
              ...
              <div style={styles.cardBody}>
                <h4 style={styles.cardTitle}>Resultados del Análisis</h4>
